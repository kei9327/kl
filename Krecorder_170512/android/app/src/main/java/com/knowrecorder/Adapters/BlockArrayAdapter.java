...
//
//public class BlockArrayAdapter extends ArrayAdapter<BlockData> {
//    private Context context;
//    private int centerX;
//    private ArrayList<BlockData> blocks;
//
//    public BlockArrayAdapter(Context context, ArrayList<BlockData> blocks, int centerX) {
...
//            }
//
//            holder.timelineBlock.setOnLongClickListener(new View.OnLongClickListener() {
//                @Override
//                public boolean onLongClick(View v) {
//                    Log.d("timelineblock","downTIme : " + blocks.get(position).getDownTime() + "   upTime : " + blocks.get(position).getUpTime());
//                    EventBus.getInstance().post(new RecordPacketDelet(blocks.get(position).getDownTime(), blocks.get(position).getUpTime()));
//                    return true;
//                }
//            });
//
