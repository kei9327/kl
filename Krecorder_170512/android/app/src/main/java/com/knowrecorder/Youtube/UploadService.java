...
//    private YoutubeHeader youtubeHeader = null;
//    private int noteId;
//
...
//
//        youtubeHeader = new YoutubeHeader();
//        youtubeHeader.setTitle(intent.getStringExtra("title"));
//        youtubeHeader.setDesc(intent.getStringExtra("desc"));
//        youtubeHeader.setCategoryId(intent.getStringExtra("categoryid"));
//        youtubeHeader.setScope(intent.getStringExtra("scope"));
//
//        credential =
...
//                    YoutubeList youtubeModel = null;
//                    youtubeModel = realm.where(YoutubeList.class).equalTo("noteId", noteId).findFirst();
//                    if (youtubeModel == null) {
//                        youtubeModel = new YoutubeList();
//                        youtubeModel.setNoteId(noteId);
//                        youtubeModel.setYoutubeLink("https://www.youtube.com/watch?v=" + videoId);
//                        realm.beginTransaction();
//                        realm.copyToRealm(youtubeModel);
//                        realm.commitTransaction();
//                    } else {
//                        realm.beginTransaction();
//                        YoutubeList newYoutube = new YoutubeList();
//                        youtubeModel.deleteFromRealm();
//                        newYoutube.setNoteId(noteId);
//                        newYoutube.setYoutubeLink("https://www.youtube.com/watch?v=" + videoId);
//                        realm.copyToRealm(newYoutube);
//                        realm.commitTransaction();
//                    }
//                    realm.close();
//                }
...
//            cursor.moveToFirst();
//
//            videoId = ResumableUpload.upload(youtube, fileInputStream, fileSize, mFileUri, cursor.getString(column_index), getApplicationContext(), youtubeHeader);
//
//
