package com.knowlounge.sectionedrecyclerviewadapter;
...
import com.knowlounge.customview.TopCropImageView;
...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            if (viewType >= entry.getValue() && viewType < entry.getValue() + VIEW_TYPE_QTY) {
                ...
                switch (sectionViewType) {
                    case VIEW_TYPE_HEADER: {
                        ...
                        if (resId == null) {
                            AppLog.i(AppLog.CLASSLIST_TAG,"Missing 'header' resource id");
                    ...
                    case VIEW_TYPE_FOOTER: {
                        ...
                        if (resId == null) {
                            AppLog.i(AppLog.CLASSLIST_TAG,"Missing 'footer' resource id");
                    ...
                    case VIEW_TYPE_LOADING: {
                        ...
                        if (resId == null) {
                            AppLog.i(AppLog.CLASSLIST_TAG,"Missing 'loading state' resource id");
                    ...
                    case VIEW_TYPE_FAILED: {
                        ...
                        if (resId == null) {
                            AppLog.i(AppLog.CLASSLIST_TAG, "Missing 'failed state' resource id");
                    ...
                    default:
                        AppLog.i(AppLog.CLASSLIST_TAG, "Invalid viewType");
    ...
    public int getItemViewType(int position) {
            ...
            if (position >= currentPos && position <= (currentPos + sectionTotal - 1)) {
                ...
                switch (section.getState()) {
                    ...
                    case FAILED:
                        return viewType + 4;
                    default:
                        AppLog.i(AppLog.CLASSLIST_TAG,"Invalid state");
        ...
        AppLog.i(AppLog.CLASSLIST_TAG,"Invalid position");
        throw new IndexOutOfBoundsException("Invalid position");
//        return  -1;
    }
