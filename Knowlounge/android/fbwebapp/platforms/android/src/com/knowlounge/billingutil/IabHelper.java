...
package com.knowlounge.billingutil;
...
//import com.wescan.code.util.AppLog;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
        ...
        do {
            ...
            logDebug("Owned items ownedSkus : " + ownedSkus.toString());
            logDebug("Owned items purchaseDataList : " + purchaseDataList.toString());
            logDebug("Owned items signatureList : " + signatureList.toString());
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////                
    ...
    public void getSkuAllDetails() {
    	
    	//AppLog.e(AppLog.IABHELPER_TAG, "getSkuAllDetails start");
    	
    	(new Thread(new Runnable() {
            public void run() {
                
            	ArrayList<String> skuList = new ArrayList<String>();
            	skuList.add("store_50star");
            	skuList.add("store_500star");
            	skuList.add("store_500star_event");
            	skuList.add("store_1200star");
            	skuList.add("store_2500star");
            	skuList.add("store_6500star");
            	skuList.add("store_15000star");
				...
				try {
	                ...
	                if (!skuDetails.containsKey(RESPONSE_GET_SKU_DETAILS_LIST)) {
	                    int response = getResponseCodeFromBundle(skuDetails);
	                    if (response != BILLING_RESPONSE_RESULT_OK) {
	                        logDebug("getSkuAllDetails() failed: " + getResponseDesc(response));
	                    }
	                    else {
	                        logError("getSkuAllDetails() returned a bundle with neither an error nor a detail list.");
	                    }
	                ...
	                for (String thisResponse : responseList) {
						try {
							...
							//AppLog.e(AppLog.IABHELPER_TAG, "getSkuAllDetails: " + d.mJson);
    ...
    void logError(String msg) {
        //AppLog.e(AppLog.IABHELPER_TAG, "In-app billing error: " + msg);
    }

    void logWarn(String msg) {
        //AppLog.w(AppLog.IABHELPER_TAG, "In-app billing warning: " + msg);
    }
}
