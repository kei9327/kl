...
/***/ function(module, exports, __webpack_require__) {
           ...
           (function (global) {
            ...
            //2015.12.04 문현균 getUserMedia시, 배경색이 바뀌는 문제 수정.
            videoEl.style['background-color'] = 'transparent';
            };
            ...
            //2015.12.04 문현균 ios에서는 video를 webView에서 띄우는 것이 아님. videoTag를 추가해주어야함 -> addVideoTag에 접근하는 방법을 몰라 getUserMedia에 임시적으로 넣어줌.
            if(!successCallback){
            console.log(successCallback);
            getUserMedia.prototype.addVideoTag_hg = addVideoTag;
            return;
            }
           ...
           (function (global) {
            ...
            exec(function (res) {
                 ...
                 var streamId = res.args.stream;
	                ...
	                //2015.12.04 문현균 streamId만이 아닌 blob전체를 가져와야하는 문제 수정.
            ...
            RTCPeerConnection.prototype.setRemoteDescription = function (sessionDescription,
                                                                         successCallback, errorCallback) {
            //2015.12.04 문현균 remoteDescription 설정 문제 해결.
